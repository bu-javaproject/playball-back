...
@Schema(description = "내가 참가한 경기 항목")
@Getter
@Builder
@AllArgsConstructor
@NoArgsConstructor
public class MyMatchResponse {
    ...
    @Schema(description = "연령대 제한 (null: 무관)", example = "null")
    ...
    @Schema(description = "주최자(호스트) 회원 ID", example = "3")
    private Long hostId;

    @Schema(description = "주최자(호스트) 닉네임", example = "풋살왕")
